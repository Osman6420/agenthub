...
| 2 | UI modernization + Turkish | **P9.1–P9.4 verified; P9.5 planned** — Turkish-first responsive shell, scenario-centred relationship management, document-set-first bulk/index lifecycle, governed connector controls, and scoped release/artifact/DSL visibility delivered without a new dependency |
