...
| 2 | UI modernization + Turkish | **P9.1–P9.3 verified; P9.4–P9.5 planned** — Turkish-first responsive shell, scenario-centred relationship management, document-set-first bulk/index lifecycle and governed connector source/mapping/schedule controls delivered without a new dependency |
