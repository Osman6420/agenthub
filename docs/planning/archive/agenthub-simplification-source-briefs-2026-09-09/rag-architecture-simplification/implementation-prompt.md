...
[tehdit modelini](threat-model.md), [ana planı](../../../master-plan.md),
...
| --- | --- |
| [Ürün mimarisi değerlendirmesi](../../rag-product-architecture-reassessment-2026-09-08/assessment.md) | Gerekçe ve başlangıç keşfi; aşağıdaki düzeltmeler önceliklidir |
| [Eski 35-model eşlemesi](../../rag-product-architecture-reassessment-2026-09-08/target-model.md) | Tarihsel taslak; proje sınırını kaldıran ve yetkileri üyeliğe indirgeyen satırları uygulama |
