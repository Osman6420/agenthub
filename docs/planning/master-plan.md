...
| Task-oriented console and unified execution experience (Phase 2.8) | **In progress — Parts 1–2 verified and owner-accepted 2026-07-22; Part 2.1 and Parts 3–7 Planned.** Remaining work adds scoped authorization and superadmin recovery, one workflow execution model, contextual scenario authoring/releases, document search profiles, question-set evaluation, unified operations and kill switches. | Part 1 shell; Part 2 organization/access contract; existing Phase 2/2.5 document/release platform; Phase 2.6 workflow/agent safety contracts | [phase-2-8 plan](phase-2-8-plan.md), [Part 1 archive](archive/phase-2-8-part-1-console-information-architecture-2026-07-22/plan.md), [Part 2 archive](archive/phase-2-8-part-2-organization-access-management-2026-07-22/plan.md), [Part 2.1](../tasks/phase-2-8-part-2-1-scoped-authorization-superadmin-recovery/plan.md), [Part 3](../tasks/phase-2-8-part-3-unified-workflow-engine/plan.md), [Part 4](../tasks/phase-2-8-part-4-scenario-authoring-release-experience/plan.md), [Part 5](../tasks/phase-2-8-part-5-document-profiles-index-automation/plan.md), [Part 6](../tasks/phase-2-8-part-6-question-sets-evaluation/plan.md), [Part 7](../tasks/phase-2-8-part-7-unified-runs-kill-switch/plan.md) | Parts 1–2 and Part 2.1 threat models complete; Part 3 must add an ADR before destructive cutover | [Part 1 verification](archive/phase-2-8-part-1-console-information-architecture-2026-07-22/verification.md); [Part 2 verification](archive/phase-2-8-part-2-organization-access-management-2026-07-22/verification.md); Part 2.1 and Parts 3–7 not yet verified |
