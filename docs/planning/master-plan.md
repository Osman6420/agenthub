...
| Task-oriented console experience (Phase 2.8) | **Part 1 verified and owner-accepted 2026-07-22** — task navigation, contextual scenario hierarchy, exact health-result lists, server-POST organization menu and UX shell landed; Parts 2–5 remain planned | Existing Phase 2/2.5 console and document plane; Phase 2.6 runtime state | [phase-2-8-plan](phase-2-8-plan.md) + [Part 1 archive](archive/phase-2-8-part-1-console-information-architecture-2026-07-22/plan.md) | Part 1 [threat model](archive/phase-2-8-part-1-console-information-architecture-2026-07-22/threat-model.md); later ADRs only if durable decisions require them | [Part 1 verification](archive/phase-2-8-part-1-console-information-architecture-2026-07-22/verification.md) |
