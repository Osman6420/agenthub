...
| Advanced enterprise orchestration (Phase 2.6) | **First parallel wave integrated and verified 2026-07-17** — P2.6.1 mapping, P2.6.8 isolation spike, P2.6.9 bounded Studio authoring context and P2.6.10 durable ingestion are merged; P2.6.7 was already in the baseline; runtime/activation closures and later waves remain independently gated | Phase 2.5 Parts 6–7, current workflow/tool/agent runtimes, durable state/resume and authorization decisions | [phase-2-6-plan](phase-2-6-plan.md) | [ADR-0008](../adr/0008-durable-workflow-transition-state-machine.md), [ADR-0009](../adr/0009-child-run-capability-attenuation.md), [ADR-0010](../adr/0010-workflow-dataflow-join-wait-and-human-task-contract.md), [ADR-0011](../adr/0011-reviewed-python-node-isolation-and-lifecycle.md) Proposed, [ADR-0012](../adr/0012-durable-ingestion-build-jobs-and-worker-readiness.md) Accepted | [First-wave integration evidence](../tasks/phase-2-6-wave-1-integration/verification.md) |
