...
Parts 1–3 are implemented and verified: exact-run containment, explicit callability, atomic served
index, and exact-role release/runtime control surfaces are closed. Part 4 governed setup and
immutable release inputs is the next milestone.
...
| UI, authorization and lifecycle closure (Phase 2.9) | **In progress; Parts 1–3 implemented and verified 2026-08-01.** Exact run containment, explicit callability, atomic served index, and exact-role release/runtime control surfaces are complete; Part 4 governed setup is next. | Phase 2.8 exact responsibilities and unified scenario/release/run/document lifecycles; canonical PostgreSQL/pgvector/RLS profile | [Phase 2.9 component plan](components/phase-2-9-ui-authorization-lifecycle-closure-plan.md) | [ADR-0016](../adr/0016-explicit-scenario-and-atomic-served-index-lifecycle.md) | [Part 1 verification](archive/phase-2-9-part-1-exact-run-authorization-postgresql-containment-2026-08-01/verification.md), [Part 2 verification](archive/phase-2-9-part-2-callable-scenario-atomic-served-index-2026-08-01/verification.md), [Part 3 verification](archive/phase-2-9-part-3-exact-role-release-runtime-controls-2026-08-01/verification.md), [audit report](../tasks/current-application-role-ui-audit/report.md) |
