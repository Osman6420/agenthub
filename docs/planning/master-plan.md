...
| Task-oriented console experience (Phase 2.8) | **Planned** — five independently gated parts; Part 1 console information architecture and UX foundation is planned, with no implementation claim | Existing Phase 2/2.5 console and document plane; Phase 2.6 runtime state | [phase-2-8-plan](phase-2-8-plan.md) + [Part 1](../tasks/phase-2-8-part-1-console-information-architecture/plan.md) | Part 1 [threat model](../tasks/phase-2-8-part-1-console-information-architecture/threat-model.md); later ADRs only if durable decisions require them | [Part 1 verification pending](../tasks/phase-2-8-part-1-console-information-architecture/verification.md) |
