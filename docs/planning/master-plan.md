...
| Advanced enterprise orchestration (Phase 2.6) | **Second wave in progress 2026-07-17** — first wave is integrated; P2.6.8 now has a disabled-by-default exact-pin/static-review/compiler/runtime seam and separate-process test harness, but no approved production sandbox or activation. Other second-wave parts and activation closures remain independently gated | Phase 2.5 Parts 6–7, current workflow/tool/agent runtimes, durable state/resume and authorization decisions | [phase-2-6-plan](phase-2-6-plan.md) | [ADR-0008](../adr/0008-durable-workflow-transition-state-machine.md), [ADR-0009](../adr/0009-child-run-capability-attenuation.md), [ADR-0010](../adr/0010-workflow-dataflow-join-wait-and-human-task-contract.md), [ADR-0011](../adr/0011-reviewed-python-node-isolation-and-lifecycle.md) Proposed, [ADR-0012](../adr/0012-durable-ingestion-build-jobs-and-worker-readiness.md) Accepted | [P2.6.8 runtime evidence](../tasks/phase-2-6-authoring-and-python-nodes/runtime-verification.md) |
