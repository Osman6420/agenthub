...
| T16 | ACK deletes the only result copy | Markdown is size/content-type/UTF-8 validated, written to tenant object storage, checksumed and transactionally referenced before ACK. ACK is idempotent and retried only under that explicit contract. |
